...
static const TaskConfig_t taskConfigs[NUM_TASK] = {
	{taskRtosUART1, "task Uart1", STACK_SIZE_GENERAL, NULL, task_UART1_PRIORITY},
    {taskRtosINT_FF, "task Freefall", STACK_SIZE_GENERAL, NULL, task_INTFF_PRIORITY},
	{taskRtosINT_DRDY, "task Ready", STACK_SIZE_GENERAL, NULL, task_INTDRDY_PRIORITY},
    {taskRtosSEC, "task Secuencia", STACK_SIZE_GENERAL, NULL, task_SECUENCIA_PRIORITY},
};
