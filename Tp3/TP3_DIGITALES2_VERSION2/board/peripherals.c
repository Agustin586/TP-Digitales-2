...
- name: BOARD_InitPeripherals
  UUID: be709bb9-85a0-4fa4-9af9-2045a3a2d851
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 19afa87c-538d-45bc-84b3-9ca0efb2482c
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: b460fdba-9a80-460c-b0cb-6b7dfb2182d0
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 94b73ebd-2291-4362-bfbb-fc58c874a541
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: 7fca7371-fe3c-4928-b196-8ea7c838d7ae
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 663ab3d8-578b-49de-a704-b7061fb7666f
  id_prefix: BOARD_
  selectedCore: core0
